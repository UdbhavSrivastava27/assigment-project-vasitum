        ...
        <div className=" flex  flex-col lg:flex-row ">
          ...
          <div>
            ...
            <div className=" flex flex-col md:flex-row space-x-3   mt-2 mr-10">
              <div className=" ml-3  w-full md:w-1/3 h-44 rounded-xl mt-4 pl-5 bg-[#FFEFE7] flex flex-col justify-between pb-3">
              ...
              <div className=" w-full md:w-1/3 h-44 rounded-xl mt-4 pl-5 bg-[#E8F0FB] flex flex-col justify-between pb-3">
              ...
              <div className=" w-full md:w-1/3 h-44 rounded-xl mt-4 pl-5 bg-[#FDEBF9]   flex flex-col justify-between pb-3">
          ...
          <div className="  md:mt-4  mr-8 flex flex-col md:flex-row lg:flex-col ">
            <div className=" border-2  w-screen md:w-auto lg:w-[490px] h-auto  lg:h-[300px] rounded-xl m-2 bg-[#161E54]">
